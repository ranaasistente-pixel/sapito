...
const DISCORD_APPLICATION_ID = process.env.DISCORD_APPLICATION_ID || "1499102503021838357";
const DISCORD_BOT_TOKEN = process.env.DISCORD_BOT_TOKEN || "";
const DISCORD_API_BASE = process.env.DISCORD_API_BASE || "https://discord.com/api/v10";

const COIN_PACKS = {
  pack1: { coins: 3, usd: 0.99, discordSkuId: "1499163258878300205" },
  pack2: { coins: 8, usd: 1.99, discordSkuId: "1499169911543562250" },
  pack5: { coins: 20, usd: 4.99, discordSkuId: "1499170403325706412" }
};
